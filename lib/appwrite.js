...
export async function createOrder(userId, userEmail, orderData) {
  try {
    ...
    console.log("✅ Order created:", document);
    return document;
  } catch (error) {
...
export async function createOrderItems(orderId, userId, cartItems) {
  try {
    ...
    for (const item of cartItems) {
      ...
      createdItems.push(document);
      console.log("✅ Order item created:", document);
    }
...
export async function getUserOrders(userId) {
  try {
    ...
    console.log(`✅ Found ${response.documents.length} orders`);
    return response.documents;
  } catch (error) {
...
export async function updateOrderStatus(orderId, newStatus) {
  try {
    ...
    console.log("✅ Order status updated:", updatedDoc);
    return updatedDoc;
  } catch (error) {
